...
function MultiSelectField({proper, properValueList, deleteProper, editProper}) {
    console.log("multi select proper value list : ", properValueList)
    ...
    return (
        ...
        <div className="multi-select-field-container">
            ...
            <div style={{display: "flex", flexDirection: "column", margin: "5px"}}>
                {properValueList.filter(p => p.properId === proper.id).map(p => {
