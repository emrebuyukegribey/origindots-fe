  ...
  return (
    <div className="register-screen-container">
      <Row align="middle" style={{ width: "100%", height: "100%" }}>
        <div className="register-screen-left-container">1</div>
        <div className="register-screen-right-container">
          <Col span={24}>
            <Row className="register-screen-signup">
              <h1>Sign Up</h1>
            </Row>
            <Row justify="center">
              <Col span={24} className="register-screen-row-container">
